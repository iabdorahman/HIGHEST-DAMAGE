...
var url="http://41.35.69.205:10086/getteaminfolist";
var url2='http://41.35.69.205:10086/gettotalplayerlist';
var online=1;//1 from API   0 from File
var solo=0;//1 solo   0 team   2 duo(undone)

var max_number_of_teams =10;
...
//team
var Fourth_Place =8;
var Fifth_Place_to_Tenth =6;
var Eleventh_to_Sixteen =4;
var Seventeen_to_Thirty_Two =2;
var Thirty_Three_to_Sixty_Four =1;

//solo
var Fourth_Place_to_Tenth =4;
var Eleventh_to_Twenty =1;
...
function search(array, insert, cb, points) {
    var left = -1,
        right = array.length,
        actual;
...
function teamtoarray(item, index) {
  	var insert = { "total_points": totalpoints(item),"rank": totalrank(item), "teamName": item.teamName,"logoPicUrl": item.logoPicUrl,"killNum": item.killNum,"liveMemberNum": item.liveMemberNum, "teamId": item.teamId };
	var index = search(array, insert, function (a) { return a.liveMemberNum; }, function (a) { return a.total_points; });
...
function teamstotable(item, index) {
	...
	{counter++;
		...
		var team='<tr>'
	      ...
	      +'<th class="team-img-td"><img src="'+item.logoPicUrl+'"></th>'
	      +'<td class="team-name-td">'+item.teamName+'</td>'
	      +'<td class="team-points-td">'+item.total_points+'P'+'</td>'
